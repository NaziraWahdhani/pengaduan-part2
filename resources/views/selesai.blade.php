...
<h1 class="font-bold ml-8 text-2xl p-6 text-center">PENGADUAN SELESAI</h1>
    ...
    <table class="w-full table-fixed">
        ...
        @foreach($laporans as $laporan)
            <tr>
                ...
                @endif
                <td class="p-2">
                    @if ($laporan->status === 'approve')
                        <span class="bg-green-500 text-white px-2 py-1 rounded-md flex items-center justify-center">
              Selesai
            </span>
                    @endif
                </td>
