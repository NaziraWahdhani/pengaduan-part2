...
<body class="dark:bg-slate-800 dark:text-slate-200">
  ...
  <h1 class="font-bold ml-8 text-2xl p-6 text-center">PENGADUAN DITOLAK</h1>
    ...
    <table class="w-full table-fixed">
      ...
      <tbody>
        ...
        <tr class="bg-gray-100 text-center">
          ...
          <td class="p-2"><button class="bg-[#4ACAA4] text-white p-2 rounded-lg"><a href="alasan.blade.php">Lihat Alasan</a></button></td>
        </tr>
