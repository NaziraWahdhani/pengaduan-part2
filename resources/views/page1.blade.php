...
<head>
    ...
    <style>
        ...
        .image-container {
            position: absolute;
            bottom: 20px; /* Sesuaikan dengan posisi yang diinginkan */
...
<button class="mt-3 text-left m-10 mb-5 p-1 ">
    ...
    <a href="{{ route('LihatTanggapan') }}" class="bg-[#4ACAA4] hover:bg-[#39A07B] text-white font-semibold py-2 px-4 rounded-full">Lihat Tanggapan</a>
</button>
